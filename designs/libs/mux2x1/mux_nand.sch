...
C {voidwalkers-scandff-gf180mcu/designs/libs/mux2x1/inv.sym} -510 310 0 0 {name=x1}
C {voidwalkers-scandff-gf180mcu/designs/libs/mux2x1/nand.sym} 10 150 0 0 {name=x2}
C {voidwalkers-scandff-gf180mcu/designs/libs/mux2x1/nand.sym} 10 290 0 0 {name=x3}
C {voidwalkers-scandff-gf180mcu/designs/libs/mux2x1/nand.sym} 460 160 0 0 {name=x4}
