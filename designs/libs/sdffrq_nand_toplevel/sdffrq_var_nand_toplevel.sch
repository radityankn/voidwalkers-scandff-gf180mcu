...
N -450 -190 -450 -150 {lab=VSS}
N -450 -210 -420 -210 {lab=#net1}
N -420 -210 -420 -190 {lab=#net1}
N -420 -190 -380 -190 {lab=#net1}
...
C {opin.sym} -20 -230 0 0 {name=p8 lab=Q
}
...
C {voidwalkers-scandff-gf180mcu/designs/libs/mux2x1/mux_nand.sym} -600 -210 0 0 {name=x1}
