...
N -670 -230 -660 -230 {lab=S}
N -670 -210 -660 -210 {lab=B}
N -670 -190 -660 -190 {lab=CLK}
...
N -670 -170 -470 -170 {lab=A}
N -660 -190 -530 -190 {lab=CLK}
...
C {lab_wire.sym} -670 -190 0 0 {name=p4 sig_type=std_logic lab=CLK}
...
C {lab_wire.sym} -670 -170 0 0 {name=p23 sig_type=std_logic lab=A}
C {lab_wire.sym} -670 -210 0 0 {name=p25 sig_type=std_logic lab=B}
C {lab_wire.sym} -670 -230 0 0 {name=p26 sig_type=std_logic lab=S}
...
device=resistor
m=1}
C {gf180mcu_voidwalkers_sc_sdffrnq_4_flattened_pex.sym} -170 -190 0 0 {name=x1}
