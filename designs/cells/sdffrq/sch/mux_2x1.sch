...
C {ipin.sym} -580 -230 0 0 {name=p6 lab=A}
C {ipin.sym} -580 -200 0 0 {name=p7 lab=B}
C {ipin.sym} -580 -40 0 0 {name=p8 lab=S}
C {iopin.sym} -610 -130 0 0 {name=p4 lab=VSS}
...
C {lab_wire.sym} -610 -130 0 0 {name=p14 sig_type=std_logic lab=VSS}
...
C {lab_wire.sym} -580 -40 0 1 {name=p24 sig_type=std_logic lab=S}
...
C {lab_wire.sym} -580 -230 0 1 {name=p28 sig_type=std_logic lab=A}
C {lab_wire.sym} -580 -200 0 1 {name=p29 sig_type=std_logic lab=B}
...
C {mux_tg.sym} 10 -240 0 0 {name=x1}
C {mux_tg.sym} 10 -90 0 0 {name=x2}
C {inv.sym} -360 -170 0 0 {name=x3}
C {inv.sym} -340 10 0 0 {name=x4}
C {inv.sym} -40 30 0 0 {name=x5}
