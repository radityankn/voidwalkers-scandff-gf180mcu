...
C {schematics/mux2x1/inv.sym} -510 310 0 0 {name=x4}
C {schematics/mux2x1/nand.sym} 460 160 0 0 {name=x1}
C {schematics/mux2x1/nand.sym} 10 150 0 0 {name=x2}
C {schematics/mux2x1/nand.sym} 10 290 0 0 {name=x3}
