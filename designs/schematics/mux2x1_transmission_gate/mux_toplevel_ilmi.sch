...
C {ipin.sym} -580 -50 0 0 {name=p6 lab=A}
C {ipin.sym} -580 -20 0 0 {name=p7 lab=B}
C {ipin.sym} -580 -130 0 0 {name=p8 lab=S}
C {iopin.sym} -590 -80 0 0 {name=p4 lab=VSS}
C {schematics/mux2x1_transmission_gate/mux_tg.sym} 10 -240 0 0 {name=x2}
C {schematics/mux2x1_transmission_gate/mux_tg.sym} 10 -90 0 0 {name=x3}
...
C {schematics/mux2x1/inv.sym} -360 -170 0 0 {name=x1}
C {schematics/mux2x1/inv.sym} -340 10 0 0 {name=x4}
C {schematics/mux2x1/inv.sym} -40 30 0 0 {name=x5}
...
C {lab_wire.sym} -580 -50 0 1 {name=p28 sig_type=std_logic lab=A}
C {lab_wire.sym} -580 -20 0 1 {name=p29 sig_type=std_logic lab=B}
